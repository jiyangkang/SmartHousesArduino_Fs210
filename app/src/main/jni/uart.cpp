...
static JNINativeMethod gMethods[] = {
        { "uartOpen", "(Ljava/lang/String;I)Ljava/io/FileDescriptor;",(void*) native_open },
        { "uartClose", "()I",(void*) native_close },
};
...
static int registerNatives(JNIEnv* env) {
    const char* kClassName = "com/hqyj/dev/smarthousesarduino/tools/UartTools"; //指定要注册的类
